...
#[test]
fn strsv_lower_transpose_padded_triangle_respected() {
    // both triangles populated to exercise lda > n 
...
#[test]
fn strsv_unitdiag_upper_notranspose() {
    let n   = 40;
    let lda = n;
...
#[test]
fn strsv_unitdiag_lower_transpose() {
    let n   = 48;
    let lda = n;
