...
fn upper_small() {
    ...
    let x  = (0..n)
        .flat_map(|i| [0.2 + 0.1 * (i as f32), -0.05 + 0.02 * (i as f32)])
        .collect::<Vec<_>>();
...
fn lower_small() {
    ...
    let a0 = make_hermitian_col_major(n, lda);
    let x  = (0..n)
        .flat_map(|i| [-0.1 + 0.03 * (i as f32), 0.07 - 0.01 * (i as f32)])
        .collect::<Vec<_>>();
...
fn large_upper() {
    ...
    let a0 = make_hermitian_col_major(n, lda);
    let x  = (0..n)
        .flat_map(|i| [0.03 + 0.001 * (i as f32), -0.02 + 0.0007 * (i as f32)])
        .collect::<Vec<_>>();
...
fn large_lower() {
    ...
    let a0 = make_hermitian_col_major(n, lda);
    let x  = (0..n)
        .flat_map(|i| [-0.02 + 0.0005 * (i as f32), 0.01 - 0.0003 * (i as f32)])
        .collect::<Vec<_>>();
