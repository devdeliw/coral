...
fn make_padded_c32(n: usize, lda: usize) -> Vec<f32> {
...
fn upper_notranspose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n,
        1,
        |k| (0.1 + 0.03 * (k as f32), -0.02 + 0.01 * (k as f32))
    );
...
fn upper_transpose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n,
        1, 
        |k| (0.25 - 0.02 * (k as f32), 0.05 - 0.01 * (k as f32))
    );
...
fn upper_conjtranspose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n,
        1,
        |k| (0.12 + 0.01 * (k as f32), -0.07 + 0.015 * (k as f32))
    );
...
fn lower_notranspose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n,
        1, |k| (-0.2 + 0.04 * (k as f32), 0.03 - 0.01 * (k as f32))
    );
...
fn lower_transpose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n,
        1, |k| (0.15 * (k as f32), -0.02 + 0.02 * (k as f32))
    );
...
fn lower_conjtranspose_small() {
    ...
    let x0  = make_strided_vec_c32(
        n, 
        1, 
        |k| (-0.06 + 0.03 * (k as f32), 0.02 - 0.01 * (k as f32))
    );
...
fn upper_notranspose_large() {
    ...
    let x0  = make_strided_vec_c32(
        n, 
        1,
        |k| (0.02 + 0.003 * (k as f32), -0.01 + 0.002 * (k as f32))
    );
...
fn upper_conjtranspose_large() {
    ...
    let x0  = make_strided_vec_c32(
        n, 
        1, 
        |k| (0.04 - 0.0002 * (k as f32), 0.015 - 0.0001 * (k as f32))
    );
...
fn strided_upper_notranspose() {
    ...
    let x    = make_strided_vec_c32(
        n, 
        incx, |k| (0.05 + 0.01 * (k as f32), -0.02 + 0.002 * (k as f32))
    );
...
fn strided_upper_conjtranspose() {
    ...
    let x    = make_strided_vec_c32(
        n, 
        incx,
        |k| (0.04 - 0.002 * (k as f32), 0.03 - 0.001 * (k as f32))
    );
...
fn unitdiag_upper_notranspose() {
    ...
    for i in 0..n {
        ...
        a[idx + 1] = -3.2 + (i as f32) * 0.05;
    }

    let x0 = make_strided_vec_c32(
        n, 
        1, 
        |k| (0.2 + 0.01 * (k as f32), -0.05 + 0.002 * (k as f32))
    );
...
fn unitdiag_lower_conjtranspose() {
    ...
    let x0 = make_strided_vec_c32(
        n, 
        1,
        |k| (-0.1 + 0.02 * (k as f32), 0.03 - 0.004 * (k as f32))
    );
...
fn n_zero_quick_return() {
    ...
    let a  = vec![0.0f32; 2 * lda];
    let x0 = vec![1.23f32, -4.56f32];
