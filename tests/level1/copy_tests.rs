...
fn real() {
    {
        ...
        let y = make_strided_vec_f32(
            n,
            1,
            |k| (-0.7 as f32) + (0.001 as f32) * k as f32,
        );
        let mut yc = y.clone();
        let mut yr = y.clone();
    ...
    }
    {
        ...
        let x = make_strided_vec_f32(
            n,
            incx,
            |k| (0.2 as f32) - (0.001 as f32) * k as f32,
        );
        let y = make_strided_vec_f32(
            n,
            incy,
...
fn complex() {
    {
        ...
        let x = make_strided_cvec_f32(
            ...
            1,
            |k| (
                (0.1 as f32) + (0.01 as f32) * k as f32,
                (-0.05 as f32) + (0.002 as f32) * k as f32,
            ),
        );
        let y = make_strided_cvec_f32(
            ...
            1,
            |k| (
                (-0.2 as f32) + (0.001 as f32) * k as f32,
                (0.3 as f32) - (0.003 as f32) * k as f32,
            ),
        );
        let mut yc = y.clone();
        let mut yr = y.clone();
    ...
    }
    {
        ...
        let x = make_strided_cvec_f32(
            ...
            incx,
            |k| (
                (0.02 as f32) * k as f32,
                (0.03 as f32) - (0.001 as f32) * k as f32,
            ),
        );
        let y = make_strided_cvec_f32(
            n,
            incy,
            |k| (
                -(0.01 as f32) * k as f32,
                (0.04 as f32) + (0.002 as f32) * k as f32,
            ),
        );
        let mut yc = y.clone();
        let mut yr = y.clone();
    ...
    }
    {
        ...
        let y = make_strided_cvec_f32(
            4,
            1,
            |k| ((1.0 as f32) + k as f32, (2.0 as f32) - k as f32),
        );
        let mut yc = y.clone();
        let mut yr = y.clone();
    ...
    }
    {
        ...
        let x = make_strided_cvec_f32(
            n,
            incx,
            |_| (3.25 as f32, -4.5 as f32),
        );
        let y = make_strided_cvec_f32(
            n,
            incy,
            |_| (-1.0 as f32, 2.0 as f32),
        );
        let mut yc = y.clone();
        let mut yr = y.clone();
