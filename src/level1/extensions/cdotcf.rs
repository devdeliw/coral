    ...
    unsafe {
        ...
        while j + 4 <= n {
            ...
            while i + 8 <= m {
                ...
                r0 = vfmaq_f32(r0, b0.1, xi1v);
                i0 = vfmaq_f32(i0, b0.0, xi1v);
                i0 = vfmsq_f32(i0, b0.1, xr1v);

                let b1: float32x4x2_t = vld2q_f32(pa1.add(p1));
                r1 = vfmaq_f32(r1, b1.0, xr1v);
                r1 = vfmaq_f32(r1, b1.1, xi1v);
                i1 = vfmaq_f32(i1, b1.0, xi1v);
                i1 = vfmsq_f32(i1, b1.1, xr1v);

                let b2: float32x4x2_t = vld2q_f32(pa2.add(p1));
                r2 = vfmaq_f32(r2, b2.0, xr1v);
                r2 = vfmaq_f32(r2, b2.1, xi1v);
                i2 = vfmaq_f32(i2, b2.0, xi1v);
                i2 = vfmsq_f32(i2, b2.1, xr1v);

                let b3: float32x4x2_t = vld2q_f32(pa3.add(p1));
                r3 = vfmaq_f32(r3, b3.0, xr1v);
                r3 = vfmaq_f32(r3, b3.1, xi1v);
                i3 = vfmaq_f32(i3, b3.0, xi1v);
                i3 = vfmsq_f32(i3, b3.1, xr1v);
