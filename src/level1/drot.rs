    ...
    if incx == 1 && incy == 1 {
        unsafe {
            ...
            while i + 16 <= n {
                ...
                let yn4 = vsubq_f64(vmulq_f64(c2, y4), vmulq_f64(s2, x4));
                let yn5 = vsubq_f64(vmulq_f64(c2, y5), vmulq_f64(s2, x5));
                let yn6 = vsubq_f64(vmulq_f64(c2, y6), vmulq_f64(s2, x6));
                let yn7 = vsubq_f64(vmulq_f64(c2, y7), vmulq_f64(s2, x7));
