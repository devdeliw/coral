...
//! - For non-unit strides, it falls back to scalar [`caxpy`] updates.
        ...
        unsafe {
            ...
            while row_idx < n_rows {
                ...
                while col_idx + NR <= n_cols {
                    ...
                    let xr0 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 0) + 0));
                    let xi0 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 0) + 1));
                    let xr1 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 1) + 0));
                    let xi1 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 1) + 1));
                    let xr2 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 2) + 0));
                    let xi2 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 2) + 1));
                    let xr3 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 3) + 0));
                    let xi3 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 3) + 1));
                    let xr4 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 4) + 0));
                    let xi4 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 4) + 1));
                    let xr5 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 5) + 0));
                    let xi5 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 5) + 1));
                    let xr6 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 6) + 0));
                    let xi6 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 6) + 1));
                    let xr7 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 7) + 0));
                    let xi7 = vdupq_n_f32(*x.get_unchecked(2*(col_idx + 7) + 1));

                    // pointers to 8 columns in matrix (convert complexes to floats by ×2)
                    ...
                    // 4 rows of complexes at a time
                    while i + 4 <= mr {
                        let pyi = y.as_mut_ptr().add(2 * (row_idx + i));
                        let mut yv: float32x4x2_t = vld2q_f32(pyi);
                        ...
                        let a4 = vld2q_f32(pa4.add(2*i));
                        yv.0 = vfmaq_f32(yv.0, xr4, a4.0);
                        yv.0 = vfmsq_f32(yv.0, xi4, a4.1);
                        yv.1 = vfmaq_f32(yv.1, xr4, a4.1);
                        yv.1 = vfmaq_f32(yv.1, xi4, a4.0);

                        let a5 = vld2q_f32(pa5.add(2*i));
                        yv.0 = vfmaq_f32(yv.0, xr5, a5.0);
                        yv.0 = vfmsq_f32(yv.0, xi5, a5.1);
                        yv.1 = vfmaq_f32(yv.1, xr5, a5.1);
                        yv.1 = vfmaq_f32(yv.1, xi5, a5.0);

                        let a6 = vld2q_f32(pa6.add(2*i));
                        yv.0 = vfmaq_f32(yv.0, xr6, a6.0);
                        yv.0 = vfmsq_f32(yv.0, xi6, a6.1);
                        yv.1 = vfmaq_f32(yv.1, xr6, a6.1);
                        yv.1 = vfmaq_f32(yv.1, xi6, a6.0);

                        let a7 = vld2q_f32(pa7.add(2*i));
                        yv.0 = vfmaq_f32(yv.0, xr7, a7.0);
                        yv.0 = vfmsq_f32(yv.0, xi7, a7.1);
                        yv.1 = vfmaq_f32(yv.1, xr7, a7.1);
                        yv.1 = vfmaq_f32(yv.1, xi7, a7.0);
                ...
                if col_idx < n_cols {
                    let xr = vdupq_n_f32(*x.get_unchecked(2*col_idx + 0));
                    let xi = vdupq_n_f32(*x.get_unchecked(2*col_idx + 1));
                    ...
                    while i + 8 <= mr {
                        ...
                        let a0 = vld2q_f32(pa0.add(2*i));
                        y0.0 = vfmaq_f32(y0.0, xr, a0.0);
                        y0.0 = vfmsq_f32(y0.0, xi, a0.1);
                        y0.1 = vfmaq_f32(y0.1, xr, a0.1);
                        y0.1 = vfmaq_f32(y0.1, xi, a0.0);
                        ...
                        let b0 = vld2q_f32(pa0.add(2*i + 8));
                        y1.0 = vfmaq_f32(y1.0, xr, b0.0);
                        y1.0 = vfmsq_f32(y1.0, xi, b0.1);
                        y1.1 = vfmaq_f32(y1.1, xr, b0.1);
                        y1.1 = vfmaq_f32(y1.1, xi, b0.0);
                    ...
                    while i + 4 <= mr {
                        ...
                        let a0 = vld2q_f32(pa0.add(2*i));
                        yv.0 = vfmaq_f32(yv.0, xr, a0.0);
                        yv.0 = vfmsq_f32(yv.0, xi, a0.1);
                        yv.1 = vfmaq_f32(yv.1, xr, a0.1);
                        yv.1 = vfmaq_f32(yv.1, xi, a0.0);
        ...
        for col_idx in 0..n_cols {
            unsafe {
                ...
                if xr != 0.0 || xi != 0.0 {
                    ...
                    caxpy(n_rows, [xr, xi], col, 1, y, incy);
                }
            }
        }
    }
