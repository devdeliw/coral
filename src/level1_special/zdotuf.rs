...
pub fn zdotuf(
        ...
        unsafe {
            ...
            while col_idx + NR <= n_cols {
                ...
                while row_idx < n_rows {
                    ...
                    // 4 complex
                    while i + 4 <= mr {
                        let x0  = vld1q_f64(x_ptr.add(2 * (row_idx + i)));
                        ...
                        acc_re0 = vfmsq_f64(acc_re0, ai0, xi0);
                        acc_im0 = vfmaq_f64(acc_im0, ar0, xi0);
                        acc_im0 = vfmaq_f64(acc_im0, ai0, xr0);
                        acc_re0 = vfmaq_f64(acc_re0, ar1, xr1);
                        acc_re0 = vfmsq_f64(acc_re0, ai1, xi1);
                        acc_im0 = vfmaq_f64(acc_im0, ar1, xi1);
                        acc_im0 = vfmaq_f64(acc_im0, ai1, xr1);

                        let b0  = vld1q_f64(col1.add(2 * i));
                        ...
                        acc_re1 = vfmsq_f64(acc_re1, bi0, xi0);
                        acc_im1 = vfmaq_f64(acc_im1, br0, xi0);
                        acc_im1 = vfmaq_f64(acc_im1, bi0, xr0);
                        acc_re1 = vfmaq_f64(acc_re1, br1, xr1);
                        acc_re1 = vfmsq_f64(acc_re1, bi1, xi1);
                        acc_im1 = vfmaq_f64(acc_im1, br1, xi1);
                        acc_im1 = vfmaq_f64(acc_im1, bi1, xr1);

                        let c0  = vld1q_f64(col2.add(2 * i));
                        ...
                        acc_re2 = vfmsq_f64(acc_re2, ci0, xi0);
                        acc_im2 = vfmaq_f64(acc_im2, cr0, xi0);
                        acc_im2 = vfmaq_f64(acc_im2, ci0, xr0);
                        acc_re2 = vfmaq_f64(acc_re2, cr1, xr1);
                        acc_re2 = vfmsq_f64(acc_re2, ci1, xi1);
                        acc_im2 = vfmaq_f64(acc_im2, cr1, xi1);
                        acc_im2 = vfmaq_f64(acc_im2, ci1, xr1);

                        let d0  = vld1q_f64(col3.add(2 * i));
                        ...
                        acc_re3 = vfmsq_f64(acc_re3, di0, xi0);
                        acc_im3 = vfmaq_f64(acc_im3, dr0, xi0);
                        acc_im3 = vfmaq_f64(acc_im3, di0, xr0);
                        acc_re3 = vfmaq_f64(acc_re3, dr1, xr1);
                        acc_re3 = vfmsq_f64(acc_re3, di1, xi1);
                        acc_im3 = vfmaq_f64(acc_im3, dr1, xi1);
                        acc_im3 = vfmaq_f64(acc_im3, di1, xr1);

                        let e0  = vld1q_f64(col4.add(2 * i));
                        ...
                        acc_re4 = vfmsq_f64(acc_re4, ei0, xi0);
                        acc_im4 = vfmaq_f64(acc_im4, er0, xi0);
                        acc_im4 = vfmaq_f64(acc_im4, ei0, xr0);
                        acc_re4 = vfmaq_f64(acc_re4, er1, xr1);
                        acc_re4 = vfmsq_f64(acc_re4, ei1, xi1);
                        acc_im4 = vfmaq_f64(acc_im4, er1, xi1);
                        acc_im4 = vfmaq_f64(acc_im4, ei1, xr1);

                        let f0  = vld1q_f64(col5.add(2 * i));
                        ...
                        acc_re5 = vfmsq_f64(acc_re5, fi0, xi0);
                        acc_im5 = vfmaq_f64(acc_im5, fr0, xi0);
                        acc_im5 = vfmaq_f64(acc_im5, fi0, xr0);
                        acc_re5 = vfmaq_f64(acc_re5, fr1, xr1);
                        acc_re5 = vfmsq_f64(acc_re5, fi1, xi1);
                        acc_im5 = vfmaq_f64(acc_im5, fr1, xi1);
                        acc_im5 = vfmaq_f64(acc_im5, fi1, xr1);

                        let g0  = vld1q_f64(col6.add(2 * i));
                        ...
                        acc_re6 = vfmsq_f64(acc_re6, gi0, xi0);
                        acc_im6 = vfmaq_f64(acc_im6, gr0, xi0);
                        acc_im6 = vfmaq_f64(acc_im6, gi0, xr0);
                        acc_re6 = vfmaq_f64(acc_re6, gr1, xr1);
                        acc_re6 = vfmsq_f64(acc_re6, gi1, xi1);
                        acc_im6 = vfmaq_f64(acc_im6, gr1, xi1);
                        acc_im6 = vfmaq_f64(acc_im6, gi1, xr1);

                        let h0  = vld1q_f64(col7.add(2 * i));
                        ...
                        acc_re7 = vfmsq_f64(acc_re7, hi0, xi0);
                        acc_im7 = vfmaq_f64(acc_im7, hr0, xi0);
                        acc_im7 = vfmaq_f64(acc_im7, hi0, xr0);
                        acc_re7 = vfmaq_f64(acc_re7, hr1, xr1);
                        acc_re7 = vfmsq_f64(acc_re7, hi1, xi1);
                        acc_im7 = vfmaq_f64(acc_im7, hr1, xi1);
                        acc_im7 = vfmaq_f64(acc_im7, hi1, xr1);
                    ...
                    while i + 2 <= mr {
                        ...
                        macro_rules! upd2 {
                            ($col:ident, $ar:ident, $ai:ident, $re:ident, $im:ident) => {{
                                ...
                                $re = vfmsq_f64($re, $ai, xi);
                                $im = vfmaq_f64($im, $ar, xi);
                                $im = vfmaq_f64($im, $ai, xr);
                            }};
                        }
            ...
            if col_idx + 4 <= n_cols {
                ...
                while row_idx < n_rows {
                    ...
                    while i + 4 <= mr {
                        ...
                        macro_rules! upd8 {
                            ($col:ident, $re:ident, $im:ident) => {{
                                ...
                                $re = vfmsq_f64($re, ai0, xi0);
                                $im = vfmaq_f64($im, ar0, xi0);
                                $im = vfmaq_f64($im, ai0, xr0);
                                $re = vfmaq_f64($re, ar1, xr1);
                                $re = vfmsq_f64($re, ai1, xi1);
                                $im = vfmaq_f64($im, ar1, xi1);
                                $im = vfmaq_f64($im, ai1, xr1);
                            }};
                        }
                    ...
                    while i + 2 <= mr {
                        let x0 = vld1q_f64(x_ptr.add(2 * (row_idx + i)));
                        let x1 = vld1q_f64(x_ptr.add(2 * (row_idx + i + 1)));
                        let xr = vuzp1q_f64(x0, x1); let xi = vuzp2q_f64(x0, x1);
    ...
    for col_idx in 0..n_cols {
        unsafe {
            ...
            let s = zdotu(n_rows, col, 1, x, incx);
