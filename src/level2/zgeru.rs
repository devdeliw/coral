...
//!
//! This function implements the BLAS [`zgeru`] routine, computing the outer-product update
//!
//! ```text
//!     A := alpha * x * y^T + A
//! ```
...
//! - `matrix` (&mut [f64]) : Input/output slice containing interleaved complex matrix `A` in column-major layout,
//!                         | updated in place.
