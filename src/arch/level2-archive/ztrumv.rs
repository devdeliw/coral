...
#[inline(always)]
unsafe fn ztrumv_unblk_accum_cm<const BF: usize>(
    unit_diag : bool,
...
#[inline(always)]
unsafe fn ztrumv_unblk_accum_cm_var(
    bf        : usize,
    unit_diag : bool,
    ablk      : *const f64,
    lda_c     : usize,
...
#[inline(always)]
unsafe fn ztrumv_unblk_scalar_trans(
    n    : usize,
    unit_diag: bool,
    conj : bool,
    a    : *const f64,
...
pub(crate) fn ztrumv(
    ...
    match trans {
        ...
        Trans::ConjTrans => ztrumv_trans_conj(
            n,
            unit_diag,
            true,
            a,
