//! `ROT`. Applies a plane rotation to two single precision vectors.
//!
    ...
    if incx == 1 && incy == 1 {
        unsafe {
            ...
            while i + 32 <= n {
                ...
                // y := cy - sx
                let yn0 = vfmsq_f32(vmulq_f32(c2, y0), s2, x0);
                let yn1 = vfmsq_f32(vmulq_f32(c2, y1), s2, x1);
                let yn2 = vfmsq_f32(vmulq_f32(c2, y2), s2, x2);
                let yn3 = vfmsq_f32(vmulq_f32(c2, y3), s2, x3);
                let yn4 = vfmsq_f32(vmulq_f32(c2, y4), s2, x4);
                let yn5 = vfmsq_f32(vmulq_f32(c2, y5), s2, x5);
                let yn6 = vfmsq_f32(vmulq_f32(c2, y6), s2, x6);
                let yn7 = vfmsq_f32(vmulq_f32(c2, y7), s2, x7);
            ...
            while i + 4 <= n {
                ...
                let yn = vfmsq_f32(vmulq_f32(c2, yv), xv, s2); 
