//! `ROT`. Applies a modified Givens rotation to two double precision vectors.
//!
...
/// - `param` (&[f64; 5])  : Slice of 5 params for the modified Givens rotation [`flag, h11, h21, h12, h22`].
///
/// # Returns
        ...
        unsafe {
            if flag < 0.0 {
                ...
                while i + 16 <= n {
                    ...
                    let xn0 = vfmaq_f64(vmulq_f64(h11v, x0), y0, h12v);
                    let xn1 = vfmaq_f64(vmulq_f64(h11v, x1), y1, h12v);
                    let xn2 = vfmaq_f64(vmulq_f64(h11v, x2), y2, h12v);
                    let xn3 = vfmaq_f64(vmulq_f64(h11v, x3), y3, h12v);
                    let xn4 = vfmaq_f64(vmulq_f64(h11v, x4), y4, h12v);
                    let xn5 = vfmaq_f64(vmulq_f64(h11v, x5), y5, h12v);
                    let xn6 = vfmaq_f64(vmulq_f64(h11v, x6), y6, h12v);
                    let xn7 = vfmaq_f64(vmulq_f64(h11v, x7), y7, h12v);

                    let yn0 = vfmaq_f64(vmulq_f64(h22v, y0), x0, h21v);
                    let yn1 = vfmaq_f64(vmulq_f64(h22v, y1), x1, h21v);
                    let yn2 = vfmaq_f64(vmulq_f64(h22v, y2), x2, h21v);
                    let yn3 = vfmaq_f64(vmulq_f64(h22v, y3), x3, h21v);
                    let yn4 = vfmaq_f64(vmulq_f64(h22v, y4), x4, h21v);
                    let yn5 = vfmaq_f64(vmulq_f64(h22v, y5), x5, h21v);
                ...
                while i + 2 <= n {
                    ...
                    let xn = vfmaq_f64(vmulq_f64(h11v, xv), yv, h12v);
                    let yn = vfmaq_f64(vmulq_f64(h22v, yv), xv, h21v);
                ...
                while i + 16 <= n {
                    ...
                    let xn0 = vfmaq_f64(x0, y0, h12v);
                    let xn1 = vfmaq_f64(x1, y1, h12v);
                    let xn2 = vfmaq_f64(x2, y2, h12v);
                    let xn3 = vfmaq_f64(x3, y3, h12v);
                    let xn4 = vfmaq_f64(x4, y4, h12v);
                    let xn5 = vfmaq_f64(x5, y5, h12v);
                    let xn6 = vfmaq_f64(x6, y6, h12v);
                    let xn7 = vfmaq_f64(x7, y7, h12v);

                    let yn0 = vfmaq_f64(y0, x0, h21v);
                    let yn1 = vfmaq_f64(y1, x1, h21v);
                    let yn2 = vfmaq_f64(y2, x2, h21v);
                    let yn3 = vfmaq_f64(y3, x3, h21v);
                    let yn4 = vfmaq_f64(y4, x4, h21v);
                    let yn5 = vfmaq_f64(y5, x5, h21v);
                ...
                while i + 2 <= n {
                    ...
                    let xn = vfmaq_f64(xv, yv, h12v);   
                    let yn = vfmaq_f64(yv, xv, h21v);   
                ...
                while i + 16 <= n {
                    ...
                    let xn0 = vfmaq_f64(y0, x0, h11v);
                    let xn1 = vfmaq_f64(y1, x1, h11v);
                    let xn2 = vfmaq_f64(y2, x2, h11v);
                    let xn3 = vfmaq_f64(y3, x3, h11v);
                    let xn4 = vfmaq_f64(y4, x4, h11v);
                    let xn5 = vfmaq_f64(y5, x5, h11v);
                    let xn6 = vfmaq_f64(y6, x6, h11v);
                    let xn7 = vfmaq_f64(y7, x7, h11v);

                    let yn0 = vsubq_f64(vmulq_f64(h22v, y0), x0);
                    let yn1 = vsubq_f64(vmulq_f64(h22v, y1), x1);
                    let yn2 = vsubq_f64(vmulq_f64(h22v, y2), x2);
                    let yn3 = vsubq_f64(vmulq_f64(h22v, y3), x3);
                    let yn4 = vsubq_f64(vmulq_f64(h22v, y4), x4);
                    let yn5 = vsubq_f64(vmulq_f64(h22v, y5), x5);
                ...
                while i + 2 <= n {
                    ...
                    let xn = vfmaq_f64(yv, xv, h11v);            
                    let yn = vsubq_f64(vmulq_f64(h22v, yv), xv); 
