...
use coral_aarch64::level2::cher2;
    ...
    match tri {
        Tri::Upper => {
            run_case(
                ...
                1,
                [1.10, -0.35],
                |i| [0.2 + 0.10 * (i as f32), -0.05 + 0.02 * (i as f32)],
                |i| [-0.3 + 0.05 * (i as f32),  0.07 - 0.01 * (i as f32)],
                true,
            );
            run_case(
                Tri::Upper,
                ...
                1,
                [-0.37, 0.20],
                |i| [0.05 + 0.002 * (i as f32), -0.02 + 0.0007 * (i as f32)],
                |i| [0.40 - 0.003 * (i as f32),  0.01 - 0.0005 * (i as f32)],
                false,
            );
        }
        Tri::Lower => {
            run_case(
                ...
                1,
                [-0.80, 0.50],
                |i| [-0.2 + 0.07  * (i as f32), 0.06 - 0.01 * (i as f32)],
                |i| [ 0.4 - 0.055 * (i as f32), -0.03 + 0.02 * (i as f32)],
                true,
            );
            run_case(
                Tri::Lower,
                ...
                1,
                [0.93, -0.10],
                |i| [-0.20 + 0.0015 * (i as f32), 0.03 - 0.0004 * (i as f32)],
                |i| [ 0.10 + 0.0020 * (i as f32), -0.01 + 0.0003 * (i as f32)],
                false,
            );
        }
    }
...
fn run_lower_padded_strided() {
    ...
    run_case(
        ...
        |i| [0.40 - 0.02 * (i as f32),  0.03 - 0.01 * (i as f32)],
        true,
    );
}
